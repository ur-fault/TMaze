...
// pub fn draw_box(mut canvas: &mut impl CanvasLike, pos: Dims, size: Dims, style: ContentStyle) {
//     draw_str(
//         &mut *canvas,
//         pos.0,
//         pos.1,
...
//         draw_char(canvas, pos.0, y, '│', style);
//         draw_char(canvas, pos.0 + size.0 - 1, y, '│', style);
//     }
//
//     draw_str(
//         canvas,
...
// pub fn draw_str(
//     mut canvas: &mut impl CanvasLike,
//     mut x: i32,
//     y: i32,
//     mut text: &str,
//     style: ContentStyle,
