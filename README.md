...
## How to run
- You can either:
- Download from [Github releases](https://github.com/ur-fault/TMaze/releases/latest), they are built automatically now, using GitHub Actions. Download the one that fits your system. Double click on it to run it.
